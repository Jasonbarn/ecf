...
@section('content')
<body style="background-color: rgb(30, 154, 123);">
...
<div class="container mx-auto p-6">
    <div class="bg-white border border-gray-300 rounded-lg shadow-lg">
        ...
        <form action="{{ route('tasks.update', $task->id) }}" method="POST" class="p-6">
            ...
            <button type="submit" class="text-white bg-gradient-to-r from-green-400 to-blue-500 hover:bg-gradient-to-br focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Mettre à jour</button>

            <a href="{{ route('tasks.accueil') }}" class="text-white bg-gradient-to-r from-red-400 to-yellow-500 hover:bg-gradient-to-br focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
